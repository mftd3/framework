 ...
 * @package mftd\facade
 * @mixin \mftd\App
 * @method static Service|null register(Service|string $service, bool $force = false) 注册服务
 * @method static mixed bootService(Service $service) 执行服务
 * @method static Service|null getService(string|Service $service) 获取服务
 * @method static \mftd\App debug(bool $debug = true) 开启应用调试模式
 * @method static bool isDebug() 是否为调试模式
 * @method static \mftd\App setNamespace(string $namespace) 设置应用命名空间
 ...
 * @method static string getmftdPath() 获取核心框架目录
 ...
 * @method static \mftd\App initialize() 初始化应用
