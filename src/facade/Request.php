 ...
 * @package mftd\facade
 * @mixin \mftd\Request
 * @method static \mftd\Request setDomain(string $domain) 设置当前包含协议的域名
 * @method static string domain(bool $port = false) 获取当前包含协议的域名
 * @method static string rootDomain() 获取当前根域名
 * @method static \mftd\Request setSubDomain(string $domain) 设置当前泛域名的值
 * @method static string subDomain() 获取当前子域名
 * @method static \mftd\Request setPanDomain(string $domain) 设置当前泛域名的值
 * @method static string panDomain() 获取当前泛域名的值
 * @method static \mftd\Request setUrl(string $url) 设置当前完整URL 包括QUERY_STRING
 * @method static string url(bool $complete = false) 获取当前完整URL 包括QUERY_STRING
 * @method static \mftd\Request setBaseUrl(string $url) 设置当前URL 不含QUERY_STRING
 ...
 * @method static \mftd\Request setRoot(string $url) 设置URL访问根地址
 * @method static string root(bool $complete = false) 获取URL访问根地址
 * @method static string rootUrl() 获取URL访问根目录
 * @method static \mftd\Request setPathinfo(string $pathinfo) 设置当前请求的pathinfo
 ...
 * @method static \mftd\Request setMethod(string $method) 设置请求类型
 ...
 * @method static \mftd\Request setRule(Rule $rule) 设置路由变量
 * @method static Rule|null rule() 获取当前路由对象
 * @method static \mftd\Request setRoute(array $route) 设置路由变量
 ...
 * @method static \mftd\Request setHost(string $host) 设置当前请求的host（包含端口）
 ...
 * @method static \mftd\Request setController(string $controller) 设置当前的控制器名
 * @method static \mftd\Request setAction(string $action) 设置当前的操作名
 ...
 * @method static \mftd\Request withMiddleware(array $middleware) 设置在中间件传递的数据
 * @method static \mftd\Request withGet(array $get) 设置GET数据
 * @method static \mftd\Request withPost(array $post) 设置POST数据
 * @method static \mftd\Request withCookie(array $cookie) 设置COOKIE数据
 * @method static \mftd\Request withSession(Session $session) 设置SESSION数据
 * @method static \mftd\Request withServer(array $server) 设置SERVER数据
 * @method static \mftd\Request withHeader(array $header) 设置HEADER数据
 * @method static \mftd\Request withEnv(Env $env) 设置ENV数据
 * @method static \mftd\Request withInput(string $input) 设置php://input数据
 * @method static \mftd\Request withFiles(array $files) 设置文件上传数据
 * @method static \mftd\Request withRoute(array $route) 设置ROUTE变量
