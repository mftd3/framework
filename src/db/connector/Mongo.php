...
use Closure;
use mftd\db\BaseQuery;
use mftd\db\builder\Mongo as Builder;
use mftd\db\Connection;
use mftd\db\exception\DbEventException;
use mftd\db\exception\DbException as Exception;
use mftd\db\Mongo as Query;
...
class Mongo extends Connection
{
    ...
    protected $cursor; // MongoDb Object
        protected $dbName = ''; // MongoCursor Object
    protected $mongo; // sessions会话列表当前会话数组key 随机生成
    protected $session_uuid; // 会话列表
protected $sessions = [];
