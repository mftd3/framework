...
use mftd\console\command\Clear;
use mftd\console\command\Help;
use mftd\console\command\Help as HelpCommand;
use mftd\console\command\Lists;
use mftd\console\command\make\Command as MakeCommand;
use mftd\console\command\make\Controller;
use mftd\console\command\make\Event;
use mftd\console\command\make\Listener;
use mftd\console\command\make\Middleware;
use mftd\console\command\make\Model;
use mftd\console\command\make\Service;
use mftd\console\command\make\Subscribe;
use mftd\console\command\make\Validate;
use mftd\console\command\optimize\Route;
use mftd\console\command\optimize\Schema;
use mftd\console\command\RouteList;
use mftd\console\command\RunServer;
use mftd\console\command\ServiceDiscover;
use mftd\console\command\VendorPublish;
use mftd\console\command\Version;
